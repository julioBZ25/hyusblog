  ...
  giscus: z.union([
    ...
    z
      .object({
         ...
         */
        commentsInput: z
          .union([z.literal("bottom"), z.literal("top")])
          .optional(),
      })
      .refine((data) => {
...
export default function integration(
  ...
  const globals = viteVirtualModulePluginBuilder(
    ...
    export const themeColor = ${JSON.stringify(
      validatedOptions.themeColor ?? "#8c5cf5"
    )};
    export const twitterHandle = ${JSON.stringify(
      validatedOptions.twitterHandle
    )};
    ...
    export const giscus = ${
      validatedOptions.giscus
        ? JSON.stringify(validatedOptions.giscus)
        : "false"
    };
  `
  );
